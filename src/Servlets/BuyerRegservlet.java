...
public class BuyerRegservlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{	
				...
				{
					resultx=userDButill.addBuyer(firstName,lastName,username,email,mobile,address,postalcode,companyName,CompanyAddress,CompanyMobile,password);
					if(resultx==true)
					{
		...
		{
			RequestDispatcher dis=request.getRequestDispatcher("error3.jsp");
			dis.forward(request,response);
		}

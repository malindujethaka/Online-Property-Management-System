...
public class accountantDButill {
	private static Connection c3=null;
	private static Statement s3=null;
	private static ResultSet r3=null;
	
	
	public static List<AccountantInformation> verify(String username,String password){
		...
		try {
		 ...
		 String sqla="select * from accountant where NIC='"+username+"'and Password='"+password+"'";

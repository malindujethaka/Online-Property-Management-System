...
<body bgcolor="DarkSlateGray">
	...
	<form id = "b15" action="log" method="post">
		<label class="a31"> Log In </label>
		<input type="text" name="username" placeholder="NIC No" class="a33" maxlength="15" required><br>
		<input type="password" name="pass"  placeholder="password" class="a34" maxlength="15" required><br><br>
		<a href="Resetpassword.jsp" class="b12">Reset password</a><br>
		<input type ="submit" name="submit" value="LogIn" class="a35">

...
<body bgcolor="DarkSlateGray">
	...
	<hr class="a4">	
	<form id = "b15" action="SellerReg.jsp" method="post">
		<br>
		<label class="b5"> Your Password Miss Match </label><br><br>
		<label class="b6">RE Try </label><br><br>
		<input type ="submit" name="submit" value="Register" class="a35">
		</form>
	<br>
		<br>
		<div>

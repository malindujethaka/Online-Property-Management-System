...
<body bgcolor="DarkSlateGray">
	...
	.	<table id="b8">
			<tr>
				<td class="a5">
					<ul id="b2">
						<li><a href="01.jsp">View Property</a></li>
						<li><a href="BuyerReg.jsp">Buy Property</a></li>
						<li><a href="SellerReg.jsp">Sell Property</a></li>
						<li><a href="01.jsp">Features</a></li>
						<li><a href="01.jsp">Benefits</a></li>
					</ul>
				</td>
				<td><img src="property.jpg " width="1260px" height="630px"></td>
			</tr>

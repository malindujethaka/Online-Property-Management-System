...
<body bgcolor="DarkSlateGray">
	...
	<hr class="a4">	
	<form id = "b15" action="Login.jsp" method="post">
		<br>
		<label class="b15"> Retry </label><br><br>
		<label class="b14"> Your Username or Current Password Invalid </label><br><br>
		<input type ="submit" name="submit" value="Try Again" class="a35">
		</form>
	<br>
		<br>
		<div>

...
<body bgcolor="DarkSlateGray">
	...
	<hr class="a4">	
	<form id = "b15" action="deleteSeller" method="post">
		<br>
		<label class="b7"> Are You </label><br><br>
		<label class="b8">Really Want Delete Your Account </label><br><br>
		<input type= "checkbox" name=delete required class="b8"><label for="delete" class="b9">YES</label> <br>
		<label class="b10">Verify User Name:</label><input type="text" name=uname placeholder="Your NIC"class="b11" required><br>
		<input type="submit" value ="DeleteAccount" class= "a36">
